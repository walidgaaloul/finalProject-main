...
export const createListing = (listing) => {
  ...
  return async (dispatch,useSelector) => {
    const isCreated = useSelector((state) => state.ListingReducer.isCreated);
    ...
    try {
      ...
      return data.id;}
        ...
        console.log('isCreatedtrue',   isCreated)
...
export const publishListing = (id, isPublish) => {
  return async (dispatch) => {
    let res = await axios.put(`/listing/${id}/publish`, { is_publish: isPublish });
