			...
			<div className="container">
				...
				<div className="row mt-5">
					<div className="left-personal col-md-7">
						<div>
							{/*name*/}
							<Name first={user.FirstName} last={user.LastName} setFirst={props.setFirst} setLast={props.setLast} />
							{/*name*/}

							<span className="line mb-4 d-block w-100"></span>
							{/*Gender*/}
							<Gender gender={user.Gender} setGender={props.setGender} />
							{/*Gender*/}

							<span className="line mb-4 d-block w-100"></span>
							{/*dob*/}
							<DOB DOB={user.Birthday} BDset={props.BDset} />
							{/*dob*/}
							<span className="line mb-4 d-block w-100"></span>
							{/*email*/}

							<Email email={user.Email} setEmail={props.setEmail} />
							{/*email*/}
