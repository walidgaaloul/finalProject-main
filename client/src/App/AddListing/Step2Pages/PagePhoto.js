...
import { removeListingPhoto, uploadPhoto } from '../../../store/actions/ListingActionss';
      ...
      if (isVerified) {
        ...
        myFileItemReader.addEventListener(
          ...
          async () => {
            ...
            const imageUrl = await uploadPhoto(currentFile);
            push({ url: imageUrl });
          },
          false
        );
...
const mapStateToProps = (state) => ({
  ...
  listingId: state.ListingReducer.listing._id,
