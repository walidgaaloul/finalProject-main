...
import {
  ...
  createListing,
  updateListing,
} from '../../store/actions/ListingActionss';
...
const STEPS = {
  step1: {
    ...
    pages: [
      ...
      { path: 'addresses', label: 'Addresses', component: PageAddresses },
  ...
  step3: {
    ...
    pages: [
      { path: 'guest_requirements', label: 'Guest Requirements', component: PageGuestRequirements, },
      { path: 'house_rules', label: 'House Rules', component: PageHouseRules },
      { path: 'availability', label: 'Availability', component: PageAvailabilitySettings3, },
